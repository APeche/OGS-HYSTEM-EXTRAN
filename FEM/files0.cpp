...
//#include "ExtranCoupling.h"
extern int ExtranCouplingVariable;
...
int ReadData ( char* dateiname, GEOLIB::GEOObjects& geo_obj, std::string& unique_name )
{
	...
	{
#endif
// ECV is Extran Coupling Variable

//	extern int ExtranCouplingVariable;	//AP_2.6.15	
//	cout << "\n";
//	cout << "Extran Coupling? (1=Y;0=N) \n";
//	cin >> ExtranCouplingVariable; 
