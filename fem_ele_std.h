...
private:
	...
	double* NodalValC1;
	double* NodalVal_Sat;
	std::vector <double> ST_Pressures;	//AP Pressure vector for ST pipe leakage function
	std::vector <double> ST_Pressures2;
	std::vector <int> ST_PressureNodeIDs;	//AP IDs for Pressure vector for ST pipe leakage function
